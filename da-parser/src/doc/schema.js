...
const baseNodes = {
  ...
  diff_added: {
    ...
    parseDOM: [
      ...
      // Note: da-loc-added is handled by loc_added node type (defined above),
      // so we don't need a duplicate entry here
    ],
  ...
  diff_deleted: {
    ...
    parseDOM: [
      ...
      // Note: da-loc-deleted is handled by loc_deleted node type (defined above),
      // so we don't need a duplicate entry here
    ],
